...
// import { urlFor } from "@/sanity/lib/image"; // Helper to build image URLs
...
//   // State to track liked cars
//   const [likedCars, setLikedCars] = useState<number[]>([]);

//   const toggleLike = (index: number) => {
//     setLikedCars((prev) =>
//       prev.includes(index)
//         ? prev.filter((i) => i !== index) // Remove from liked
//         : [...prev, index] // Add to liked
//     );
//   };
...
//                   onClick={() => toggleLike(index)} // Toggle liked state
//                 >
...
//   const toggleLike = (index: number, carName: string) => {
//     setLikedCars((prev) =>
//       prev.includes(index)
//         ? prev.filter((i) => i !== index) // Remove from liked
//         : [...prev, index] // Add to liked
...
//       setNotification(`${carName} add to Favorite!`);
...
//                 <div
//                   className="cursor-pointer text-xl"
//                   onClick={() => toggleLike(index, product.name)} // Toggle liked state with car name
//                 >
//                   {likedCars.includes(index) ? (
//                     <AiFillHeart className="text-red-600 transition-transform duration-300 transform hover:scale-125" />
//                   ) : (
...
//         <Link href="/wishlist">
//           <button className="bg-gradient-to-r from-green-500 to-green-700 px-6 py-3 text-white font-medium rounded-lg hover:from-green-700 hover:to-green-900 transform hover:scale-105 transition-transform duration-300">
//             View Wishlist
//           </button>
//         </Link>
//       </div>
